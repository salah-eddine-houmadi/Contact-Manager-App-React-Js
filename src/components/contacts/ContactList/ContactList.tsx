...
let ContactList= () => {
    ...
    let clickDelete = async (contactID:any) =>{
        try {
                    ...
                    <div className="grid">
                        <div className="row">
                            <div className="col">
                                ...
                                <p className='fst-italic'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam necessitatibus, vero voluptatibus expedita dolores nam aperiam sunt nihil ab, placeat eius impedit repudiandae pariatur, debitis consectetur? At nihil laboriosam excepturi.</p>
                            </div>
                        </div>
                        <div className="row">
